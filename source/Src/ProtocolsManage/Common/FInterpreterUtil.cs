...
namespace ProtocolsManage.Common
{
    public class FInterpreterUtil
    {
        ...
        /// <returns></returns>
        public static Dictionary<string, byte[]> SplitData(FInterpretersModel fInterpretersModel, byte[] bytestr)
        {
            //按照协议对数据进行分组
        ...
        public static void AnalysisByte(DataBodyModel dataBodyModel, Dictionary<string, string> dicDatas, byte[] childData)
        {
            byte[] subChildData = childData.CloneRange(dataBodyModel.StartPosition, dataBodyModel.DataLength);
            //处理数据方式
            DataByteModel dataByteModel = dataBodyModel.DataByteModel;
        ...
        public static void AnalysisBitState(DataBodyModel dataBodyModel, Dictionary<string, string> dicDatas, byte[] childData)
        {
            byte[] subChildData = childData.CloneRange(dataBodyModel.StartPosition, dataBodyModel.DataLength);
            //处理数据方式
            List<DataBitModel> dataBitModel = dataBodyModel.DataBitModels;
            foreach (DataBitModel itemDataBit in dataBitModel)
            {
                //支持单字节按位处理
        ...
        public static void AnalysisBit(DataBodyModel dataBodyModel, Dictionary<string, string> dicDatas, byte[] childData)
        {
            byte[] subChildData = childData.CloneRange(dataBodyModel.StartPosition, dataBodyModel.DataLength);
            //处理数据方式
            List<DataBitModel> dataBitModel = dataBodyModel.DataBitModels;
        ...
        public static void AnalysisBitBool(DataBodyModel dataBodyModel, Dictionary<string, string> dicDatas, byte[] childData)
        {
            byte[] subChildData = childData.CloneRange(dataBodyModel.StartPosition, dataBodyModel.DataLength);
            //处理数据方式
            DataByteModel dataByteModel = dataBodyModel.DataByteModel;
